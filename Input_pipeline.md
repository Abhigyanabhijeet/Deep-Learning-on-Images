...
•	Use cv2.SetMouseCallBack to draw rectangle around object. https://docs.opencv.org/3.0-beta/doc/py_tutorials/py_gui/py_mouse_handling/py_mouse_handling.html
...
The second reliable source is using tensor flow. The functions are well described on tensor flow site: https://www.tensorflow.org/api_docs/python/tf/image 
But if you are newbie and tensor flow makes little sense you can follow this blog spot which has clearly descripted how to use functions:  https://medium.com/ymedialabs-innovation/data-augmentation-techniques-in-cnn-using-tensorflow-371ae43d5be9
...
Source : https://play.pixelblaster.ro/blog/2017/01/20/how-to-shuffle-two-arrays-to-the-same-order/

Saving Model: 
It is described well how to save architecture and model weights at https://jovianlin.io/saving-loading-keras-models/
